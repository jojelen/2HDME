...
& eta1D,eta1L,eta2D,eta2L,M12,M112,M222,vd,vu,gTAh,gThh,gTHm,gTVWm,gTVZ,gFeFecFdFd,      & 
...
Real(dp),Intent(in) :: gTAh(2),gThh(2),gTHm(2),gTVWm,gTVZ

Real(dp) :: gFeFecFdFdi(3,3,3),gFeFecFeFei(3,3,3),gFeFecFuFui(3,3,3),gFeFecFvFvi(3,3,3),          & 
& gFeFvcFuFdi(3,3,3)

Real(dp) :: gTAhtemp(2),gThhtemp(2),gTHmtemp(2),gTVWmtemp,gTVZtemp
...
& eta1U,eta2U,eta1D,eta1L,eta2D,eta2L,M12,M112,M222,vd,vu,cplcFdFdAhL,cplcFdFdAhR,       & 
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MVZ,MAh(2),Mhh(2)
...
Real(dp),Intent(in) :: MFe(3),MVZ,MAh(2),Mhh(2)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MVZ,MAh(2),Mhh(2)

Complex(dp),Intent(in) :: cplcFeFeAhL(3,3,2),cplcFeFeAhR(3,3,2),cplcFeFehhL(3,3,2),cplcFeFehhR(3,3,2),          & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),               & 
...
coup2(8) = cplcFvFecVWmL(gt2,gt1) 
coup2(7) = cplcFvFecVWmR(gt2,gt1) 
Call IntegrateGaugeST(Boson4, mass, coup2, deltaM, epsI,IntegralVVst,NVVst, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = -2._dp*resC 
resC= 1*resC ! color factor 
...
coup2(5) = cplcFvFvVZL(gt2,gt3) 
coup2(6) = cplcFvFvVZR(gt2,gt3) 
coup2(8) = cplcFvFecHmL(gt2,gt1,i2) 
coup2(7) = cplcFvFecHmR(gt2,gt1,i2) 
coupT = coup2(7) 
coup2(7) = coup2(8) 
coup2(8) = coupT 
Call IntegrateGaugeSscalarT(Boson4, mass, coup2, deltaM, epsI,IntegralVSst,NVSst, resC, check) 
