...
Module OneLoopDecay_Fu_THDM_GEN
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_THDM_GEN_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,              & 
& MFu,MAh2,MFu2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDM_GEN_FuToFuAh


Subroutine Gamma_Real_THDM_GEN_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,        & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDM_GEN_FuToFuAh


Subroutine Amplitude_WAVE_THDM_GEN_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFuAh


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
...
ML2 = MHm(i2) 
ML3 = MHm(i3) 
coup1L = cplcFuFdcHmL(gt1,i1,i2)
coup1R = cplcFuFdcHmR(gt1,i1,i2)
...
ML2 = MFd(i2) 
ML3 = MFd(i3) 
coup1L = cplcFuFdcHmL(gt1,i2,i1)
coup1R = cplcFuFdcHmR(gt1,i2,i1)
coup2L = cplcFdFuHmL(i3,gt2,i1)
coup2R = cplcFdFuHmR(i3,gt2,i1)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuAh


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuAh


Subroutine Amplitude_Tree_THDM_GEN_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,               & 
...
Mex3 = MHm(gt3) 
! Tree-Level Vertex 
coupT1L = cplcFuFdcHmL(gt1,gt2,gt3)
coupT1R = cplcFuFdcHmR(gt1,gt2,gt3)
Call TreeAmp_FtoFS(Mex1,Mex2,Mex3,coupT1L,coupT1R,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1, gt2, gt3) = AmpC 
    End Do
  End Do
End Do
End Subroutine Amplitude_Tree_THDM_GEN_FuToFdcHm


Subroutine Gamma_Real_THDM_GEN_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,     & 
...
Do i1=1,3
  Do i2=1,3
    Do i3=2,2
CoupL = cplcFuFdcHmL(i1,i2,i3)
CoupR = cplcFuFdcHmR(i1,i2,i3)
Mex1 = MFu(i1)
Mex2 = MFd(i2)
Mex3 = MHm(i3)
If (Abs(Mex1).gt.(Abs(Mex2)+Abs(Mex3))) Then 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDM_GEN_FuToFdcHm


Subroutine Amplitude_WAVE_THDM_GEN_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,               & 
...
! Coupling counter term 
!----------------------------- 
ZcoupT1L = ctcplcFuFdcHmL(gt1,gt2,gt3) 
ZcoupT1R = ctcplcFuFdcHmR(gt1,gt2,gt3) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfUR(i1,gt1)*cplcFuFdcHmL(i1,gt2,gt3)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfUL(i1,gt1))*cplcFuFdcHmR(i1,gt2,gt3)
End Do


! External Field 2 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfDL(i1,gt2)*cplcFuFdcHmL(gt1,i1,gt3)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfDR(i1,gt2))*cplcFuFdcHmR(gt1,i1,gt3)
End Do


! External Field 3 
Do i1=1,2
ZcoupT1L = ZcoupT1L + 0.5_dp*Conjg(ZfHm(i1,gt3))*cplcFuFdcHmL(gt1,gt2,i1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfHm(i1,gt3))*cplcFuFdcHmR(gt1,gt2,i1)
End Do
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFdcHm


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
...
coup3L = cplcFuFdcHmL(i2,i3,gt3)
coup3R = cplcFuFdcHmR(i2,i3,gt3)
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3L)+Abs(coup3R)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_SFF(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3L,coup3R,AmpC) 
Else
 AmpC = 0._dp
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFdcHm


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,    & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,    & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFdcHm


Subroutine Amplitude_Tree_THDM_GEN_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,            & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDM_GEN_FuToFdcVWm


Subroutine Gamma_Real_THDM_GEN_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,  & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDM_GEN_FuToFdcVWm


Subroutine Amplitude_WAVE_THDM_GEN_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,            & 
& ctcplcFuFdcVWmL,ctcplcFuFdcVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,           & 
& ZfUR,ZfVWm,Amp)
...
! External Field 1 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*Conjg(ZfUL(i1,gt1))*cplcFuFdcVWmL(i1,gt2)
ZcoupT1R = ZcoupT1R + 0.5_dp*ZfUR(i1,gt1)*cplcFuFdcVWmR(i1,gt2)
End Do


! External Field 2 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfDL(i1,gt2)*cplcFuFdcVWmL(gt1,i1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfDR(i1,gt2))*cplcFuFdcVWmR(gt1,i1)
End Do
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFdcVWm


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,MVG,              & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,    & 
...
& cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3,2),cplcFdFdAhR(3,3,2),cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),          & 
& cplAhHmcVWm(2,2),cplcFdFdhhL(3,3,2),cplcFdFdhhR(3,3,2),cplcFdFdVGL(3,3),               & 
...
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhHmcVWm(2,2),  & 
& cplhhcVWmVWm(2),cplHmcVWmVP(2),cplHmcVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,               & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,            & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,               & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFdcVWm


Subroutine Amplitude_Tree_THDM_GEN_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,              & 
& Mhh,MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDM_GEN_FuToFuhh


Subroutine Gamma_Real_THDM_GEN_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,        & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDM_GEN_FuToFuhh


Subroutine Amplitude_WAVE_THDM_GEN_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,    & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFuhh


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuhh


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuhh


Subroutine Amplitude_Tree_THDM_GEN_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,              & 
& MVZ,MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDM_GEN_FuToFuVZ


Subroutine Gamma_Real_THDM_GEN_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,        & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDM_GEN_FuToFuVZ


Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVZ


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
...
& cplcFuFuVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplAhhhVZ(2,2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),& 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
...
& cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhVZVZ(2),cplHmcHmVZ(2,2),      & 
& cplHmcVWmVZ(2),cplcHmVWmVZ(2),cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
& cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,             & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,             & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVZ


Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,    & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVG


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
& MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,        & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),              & 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
& cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),           & 
& cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3), & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVG


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVG


Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,      & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDM_GEN_FuToFuVP


Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
& MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,        & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,2),cplcFuFuAhR(3,3,2),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),              & 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
& cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),           & 
& cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3), & 
& cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplHmcHmVP(2,2),cplHmcVWmVP(2),    & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDM_GEN_FuToFuVP


Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDM_GEN_FuToFuVP



End Module OneLoopDecay_Fu_THDM_GEN
