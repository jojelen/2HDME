...
// SPheno writes a bunch of temp files. This is a clean up action.
            ...
            if (error == -1)
                _console.error
                    << "[ERROR]: Couldn't clean up temp directory.\n";
#endif
...
void BaseModel::print_2hdme_info() {
    ...
    color1(
        " |___ \\| | | |  _ \\|  \\/  |     | ____|_   _____ | |_   _____ _ "
        "__");
    color1(
        "   __) | |_| | | | | |\\/| |_____|  _| \\ \\ / / _ \\| \\ \\ / / _ "
        "\\ '__|");
    color1(
        "  / __/|  _  | |_| | |  | |_____| |___ \\ V / (_) | |\\ V /  __/ |");
    color1(
...
void BaseModel::disable_logo() { std::atomic_exchange(&_first_run, false); }
